...
<body class="min-h-screen bg-[#F8FAFC] text-slate-950 antialiased selection:bg-blue-200 selection:text-slate-950">
    <div class="relative isolate overflow-hidden">
        <div class="absolute inset-x-0 top-0 -z-10 h-192 bg-[radial-gradient(circle_at_20%_20%,rgba(66,133,244,0.18),transparent_30%),radial-gradient(circle_at_78%_10%,rgba(52,168,83,0.12),transparent_26%),linear-gradient(180deg,#f8fafc_0%,#eef4ff_54%,#f8fafc_100%)]"></div>
        <div class="absolute left-0 top-0 -z-10 h-136 w-136 -translate-x-1/2 rounded-full bg-slate-900/5 blur-3xl"></div>

        <header x-data="{ open: false }" class="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-6 lg:px-8">
            <a href="{{ url('/') }}" class="group flex items-center gap-3">
                <span class="grid h-11 w-11 place-items-center rounded-2xl bg-slate-950 shadow-xl shadow-slate-950/15 transition duration-300 group-hover:scale-105">
            ...
            <div class="hidden items-center gap-3 md:flex">
                ...
                <a href="{{ Route::has('register') ? route('register') : url('/register') }}" class="group relative overflow-hidden rounded-2xl bg-slate-950 px-5 py-2.5 text-sm font-bold text-white shadow-xl shadow-slate-950/15 transition duration-300 hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-slate-950/20">
                    <span class="absolute inset-0 -translate-x-full bg-linear-to-r from-transparent via-white/20 to-transparent transition duration-700 group-hover:translate-x-full"></span>
        ...
        <main>
            <section class="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-16 pt-10 sm:px-6 md:pt-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-24">
                <div>
                    <div class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/78 px-3 py-2 text-xs font-bold text-slate-600 shadow-sm backdrop-blur">
                    ...
                    <form action="{{ Route::has('jobs.index') ? route('jobs.index') : url('/jobs') }}" method="GET" x-data="{ focused: false, role: '' }" class="mt-8 max-w-2xl">
                        ...
                        <div class="group relative rounded-[1.65rem] border border-slate-200 bg-white p-2 shadow-xl shadow-slate-950/8 transition-all duration-500 ease-in-out" :class="focused ? 'scale-[1.015] border-blue-300 shadow-2xl shadow-blue-500/12' : ''">
                            <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                                ...
                                <button type="submit" class="group/btn relative min-h-14 overflow-hidden rounded-[1.25rem] bg-slate-950 px-6 text-sm font-extrabold text-white shadow-lg shadow-slate-950/16 transition duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-950/18 sm:px-7">
                    ...
                    <div class="mt-7 flex flex-col gap-3 sm:flex-row">
                        <a href="{{ Route::has('register') ? route('register') : url('/register') }}" class="group inline-flex items-center justify-center gap-2 rounded-2xl bg-[#4285F4] px-5 py-3.5 text-sm font-extrabold text-white shadow-xl shadow-blue-500/18 transition duration-300 hover:-translate-y-1 hover:scale-[1.015] hover:shadow-2xl hover:shadow-blue-500/24">
                        ...
                        <a href="#features" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3.5 text-sm font-extrabold text-slate-800 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-950/8">See how it works</a>
                    </div>
                </div>

                <div class="relative lg:pl-8">
                    <div class="slow-drift absolute -right-5 -top-7 h-28 w-28 rounded-4xl bg-[#FBBC05]/18 blur-2xl"></div>
                    <div class="relative overflow-hidden rounded-[2.2rem] border border-white bg-slate-950 p-3 shadow-2xl shadow-slate-950/18">
                        ...
                        <div class="relative rounded-[1.7rem] border border-white/10 bg-white/5.5 p-4 backdrop-blur">
                            <div class="flex items-center justify-between gap-4">
                                ...
                                <span class="rounded-full bg-emerald-400/12 px-3 py-1.5 text-xs font-bold text-emerald-200 ring-1 ring-emerald-300/20">84% fit</span>
                            </div>

                            <div class="mt-6 grid gap-3">
                                <article class="group rounded-[1.35rem] border border-white/10 bg-white/6 p-4 transition duration-300 hover:-translate-y-1 hover:bg-white/9">
                                    <div class="flex items-start justify-between gap-4">
                                        ...
                                        <span class="rounded-full bg-blue-400/12 px-2.5 py-1 text-[0.68rem] font-bold text-blue-200">New</span>
                                    </div>
                                    <div class="mt-4 flex flex-wrap gap-2">
                                        <span class="rounded-full bg-white/8 px-2.5 py-1 text-[0.7rem] font-semibold text-slate-300">Laravel</span>
                                        <span class="rounded-full bg-white/8 px-2.5 py-1 text-[0.7rem] font-semibold text-slate-300">MySQL</span>
                                        <span class="rounded-full bg-white/8 px-2.5 py-1 text-[0.7rem] font-semibold text-slate-300">API</span>
                                    </div>
                                </article>

                                <article class="rounded-[1.35rem] border border-white/10 bg-white/4.5 p-4">
                                    ...
                                    <div class="mt-3 h-2 rounded-full bg-white/10">
                                        <div class="h-full w-[76%] rounded-full bg-linear-to-r from-[#4285F4] via-[#34A853] to-[#FBBC05]"></div>
                                    </div>
                                </article>
                            </div>

                            <div class="mt-6 grid grid-cols-3 gap-3">
                                <div class="rounded-[1.25rem] border border-white/10 bg-white/5.5 p-3">
            ...
            <section id="features" class="mx-auto max-w-7xl px-5 py-12 sm:px-6 lg:px-8 lg:py-20">
                ...
                <div class="mt-10 grid gap-4 md:grid-cols-6">
                    <article class="group relative overflow-hidden rounded-4xl border border-slate-200 bg-white p-6 shadow-sm transition duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10 md:col-span-3 lg:col-span-2">
                        <div class="absolute inset-x-8 top-0 h-px bg-linear-to-r from-transparent via-[#4285F4]/60 to-transparent opacity-0 transition duration-500 group-hover:opacity-100"></div>
                    ...
                    <article class="group relative overflow-hidden rounded-4xl border border-slate-200 bg-slate-950 p-6 shadow-xl shadow-slate-950/12 transition duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-950/20 md:col-span-3 lg:col-span-2">
                        <div class="absolute -right-10 -top-12 h-32 w-32 rounded-full bg-[#34A853]/20 blur-2xl"></div>
                        <span class="grid h-12 w-12 place-items-center rounded-2xl bg-white/8 text-[#34A853] ring-1 ring-white/10">
                    ...
                    <article class="group relative overflow-hidden rounded-4xl border border-slate-200 bg-white p-6 shadow-sm transition duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-yellow-500/10 md:col-span-6 lg:col-span-2">
                        <div class="absolute bottom-0 left-6 right-6 h-px bg-linear-to-r from-transparent via-[#FBBC05]/80 to-transparent opacity-0 transition duration-500 group-hover:opacity-100"></div>
            ...
            <section id="insights" class="mx-auto max-w-7xl px-5 py-10 sm:px-6 lg:px-8">
                <div class="overflow-hidden rounded-[2.4rem] bg-slate-950 p-5 shadow-2xl shadow-slate-950/16 sm:p-8 lg:p-10">
                    <div class="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-center">
                        ...
                        <div class="grid gap-3 sm:grid-cols-3">
                            <div class="rounded-[1.7rem] border border-white/10 bg-white/5.5 p-5">
                            ...
                            <div class="rounded-[1.7rem] border border-white/10 bg-white/5.5 p-5 sm:translate-y-7">
            ...
            <section id="outcomes" class="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8 lg:py-24">
                <div class="relative overflow-hidden rounded-[2.4rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-950/8 sm:p-10">
                    <div class="absolute right-8 top-8 hidden h-16 w-16 rounded-3xl bg-[#EA4335]/10 sm:block"></div>
                    <div class="absolute bottom-8 right-24 hidden h-10 w-10 rounded-2xl bg-[#34A853]/12 sm:block"></div>
                    <div class="max-w-2xl">
                    ...
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        <a href="{{ Route::has('register') ? route('register') : url('/register') }}" class="group inline-flex items-center justify-center rounded-2xl bg-slate-950 px-6 py-4 text-sm font-extrabold text-white shadow-xl shadow-slate-950/[0.14] transition duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-950/18">
                            Create free account
